...
# Dataset
tf.app.flags.DEFINE_integer('cantidad_imagenes_train', 5474, 'Cantidad de imagenes distintas para entrenamiento')
tf.app.flags.DEFINE_integer('cantidad_imagenes_eval', 3232, 'Cantidad de imagenes distintas para evaluar modelo')
